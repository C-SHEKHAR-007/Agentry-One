...
def load_publisher(platform: str) -> Callable[[str, str], str]:
    """Returns the `post(access_token: str, text: str) -> str` function from
    social-connectors/<platform>/publish.py. Raises NotImplementedError with
    a clear message if that platform has no publish adapter yet."""
